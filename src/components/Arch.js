  ...
  useFrame((state, delta) => {
    if (ship.current) {
      if (mutation.shouldShiftItems) {
        arches.current.position.z =
          mutation.currentLevelLength - PLANE_SIZE * (LEVEL_SIZE - 2) - 300;
